...
<head>
	...
	<link rel="stylesheet" type="text/css" media="all" href="./css/querie.css"/>
<?php
switch ($_GET['section']) {
	case "portada":
	case "nuevas":
...
<?php if (isset($_SESSION["login"]["name"])) { ?>
	<li class="usertext">
		Bienvenido <b><?php echo $_SESSION["login"]["name"]; ?></b> (<a href="./login/logout.php" title="Click para cerrar sesión">Salir</a>)
	</li>
<?php } else { ?>
	<li class="usertext">
